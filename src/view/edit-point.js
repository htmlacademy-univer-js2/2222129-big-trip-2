  ...
  <form class="event event--edit" action="#" method="post">
    ...
    <section class="event__details">
      ...
      `<div class="event__offer-selector">
              <input class="event__offer-checkbox  visually-hidden" id="event-offer-${formattOfferTitles(typeOffer.title)}-1" type="checkbox" name="event-offer-${formattOfferTitles(typeOffer.title)}" ${point.offers.includes(typeOffer.id) ? 'checked' : ''}>
              <label class="event__offer-label" for="event-offer-${formattOfferTitles(typeOffer.title)}-1">
      ...
      <section class="event__section  event__section--destination">
        ...
        <div class="event__photos-container">
          <div class="event__photos-tape">
            ${pointDestinations.pictures.map((pic) => `<img class="event__photo" src="${pic.src}" alt="${pic.description}">`)} 
          </div>
        </div>
      </section>
    </section>
